...
*Please note: You might find that there are missing pages in the final pdf. These missing pages are generally completely white pages without any content. This is due to the way the script compares the content of pdf pages and can not be avoided but as these pages have no content this flaw is unimportant!*
